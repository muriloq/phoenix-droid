...
public class Phoenix extends i8080 {
  public static final int CONTROL_COIN=0;
  public static final int CONTROL_START1=1;
  public static final int CONTROL_START2=2;
  public static final int CONTROL_FIRE=4;
  public static final int CONTROL_RIGHT=5;
  public static final int CONTROL_LEFT=6;
  public static final int CONTROL_DOWN=7;
  ...
  public final boolean setGameControlFlags( int controlPos, boolean down) {
    if (controlPos<NUM_CONTROLS) {
      gameControl[controlPos]=down?1:0;
      Log.d("Pheonix","Gamecontrol "+ 
          "coin="+gameControl[CONTROL_COIN]+" "+
          "start1="+gameControl[CONTROL_START1]+" "+
          "start2="+gameControl[CONTROL_START2]+" "+
          "fire="+gameControl[CONTROL_FIRE]+" "+
          "right="+gameControl[CONTROL_RIGHT]+" "+
          "left="+gameControl[CONTROL_LEFT]+" "+
          "down="+gameControl[CONTROL_DOWN]+" ");
      return true;
    }
    return false;
  }
